...
<html>
    <head>
        <title>MHi-CARE: Patient Portal</title>
	<meta charset="utf-8" />
	...
	<div id="page-wrapper">
		...
		<div class="container" id="main">
			...
			<div class="4u 12u(narrower)">
				...
				<section>
                                    <header>
					<h3>Interested in Taking Part in Research?</h3>
                                    </header>
                                    <p class="blueText">Lorem ipsum dolor sit amet consectetur et sed adipiscing elit. Curabitur et vel
			...
			<section class="4u 12u(narrower) feature">
				...
				<a href="https://mychart.hopkinsmedicine.org/MyChart/" class="image featured"><img src="images/gradient.png" alt="" /></a>
                            </div>
                            <header>
				<h3>My Chart</h3>
                            </header>
				...
				vel sem sit dolor neque semper magna lorem ipsum.</p>
                            <ul class="actions">
				<li><a href="https://mychart.hopkinsmedicine.org/MyChart/" class="button">Click Here</a></li>
                            </ul>
			</section>
			<section class="4u 12u(narrower) feature">
                            <div class="image-wrapper">
